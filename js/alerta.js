...
function alertaDatoIngresado(){
        var errormsg = "Resulta imposible realizar el calculo de tiro oblicuo para los datos ingresados.";
        var alerta = alertify.alert('ATENCION',errormsg);
    }
